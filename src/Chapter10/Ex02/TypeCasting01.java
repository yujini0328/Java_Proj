...
//		System.out.println(a2.tigerCry);	// Tiger의 필드/메소드는 접근 안됨
		...
		// 다운캐스팅 : 부모 ====> 자식 변환, 명시해서 변환, 반드시 instanceof를 사용해서 실행시 오류나지 않도록 처리가 필요함.
		Tiger tt1 = (Tiger) a2;
		
		//tt1는 Tiger 타입을 다운 캐스팅 : Tiger/Animal <<== 부모/자식 필드/메소드 모두 사용가능
		...
		Animal aa2 = l1;
			...
			// aa2는 Animal의 필드/메소드만 접근되고, Animal / Lion
