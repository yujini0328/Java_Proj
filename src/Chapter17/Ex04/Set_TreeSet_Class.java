...
class MyClass3 implements Comparable<MyClass3>{
	String data1;	// <== 정렬해서 TreeSet에 저장하도록 설
	String data2;
	...
	public static void main(String[] args) {
		/*
		 	TreeSet <E> : 1. Set<E>을 인터페이스를 구현한 클래스, 2. 중복된 값을 넣을 수 없다, 3. 방번호가 없다.
		 	 			  4. 같이 정렬되어서 들어간다(오름차순 정렬), 5. 검색/정렬 기능의 메소드가 추가적으로 들어있다. 
...
//		mySet.add(new MyClass(1,1)); mySet.add(new MyClass(5,5)); mySet.add(new MyClass(3,3));
		...
		// 2. MyClass2 객체를 TreeSet에 저장 <== Comparable 인터페이스의 comparTo() 메소드를 재정의 함 : data1 : data1 필드를 정렬해서 
